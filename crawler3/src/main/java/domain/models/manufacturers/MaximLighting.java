...
public class MaximLighting extends Manufacturer implements ICrawler {

    public int manufacturer_id = 88;
    ...
    public ArrayList<String> getSeeds() {
        ...
        try {
            ...
            for (Row row : sheet) {
                ...
                seeds.add("http://www.maximlighting.com/product-search/" + sku);
            }
        }catch (Exception e){
            e.printStackTrace();
        }
    ...
    public boolean shouldVisit(Page referringPage, WebURL url) {
        ...
        if(href.contains("plus.google.com")
            ...
            if(href.contains("maximlighting.com")){
