...
<div class="container pt2 mt3" id="main" ng-app="edu" ng-controller="SchoolController"
    ...
    <div class="col-xs-12 mt2" ng-hide="schoolCompetition.school_year.year.open == 0">
        <button class="btn btn-success pull-right" ng-click="updateAllStudents(schoolCompetition.students)">Save All Student Scores</button>
    </div>
    <div class="col-xs-12 mt2" ng-hide="schoolCompetition.school_year.year.open == 0">
        <table class="table table-striped">
            ...
            <tr ng-repeat="s in schoolCompetition.students">
                ...
                <td class="col-xs-1"><input ng-disabled="schoolCompetition.school_year.year.openTest < 1" ng-model="s.test1_score" type="number" class="form-control" max="25"></td>
                <td class="col-xs-1"><input ng-disabled="schoolCompetition.school_year.year.openTest < 2" ng-model="s.test2_score" type="number" class="form-control" max="25"></td>
                <td class="col-xs-1"><input ng-disabled="schoolCompetition.school_year.year.openTest < 3" ng-model="s.test3_score" type="number" class="form-control"max="25"></td>
                <td class="col-xs-1"><input ng-disabled="schoolCompetition.school_year.year.openTest < 4" ng-model="s.test4_score" type="number" class="form-control" max="25"></td>
